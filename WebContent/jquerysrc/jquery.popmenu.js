...
//                $("#demo_ul_6").css("left", xaix + "px").css("top", myEvent.clientY + 80 + "px").css("z-index", "99");
                ...
                $("#demo_ul_1").css("left", x + "px").css("top", y + "px").css("z-index", "99");
                $("#demo_ul_2").css("left", x + "px").css("top", y + "px").css("z-index", "99");
                $("#demo_ul_3").css("left", x + "px").css("top", y + "px").css("z-index", "99");
                $("#demo_ul_4").css("left", x + "px").css("top", y + "px").css("z-index", "99");
                $("#demo_ul_5").css("left", x + "px").css("top", y + "px").css("z-index", "99");
                $("#demo_ul_6").css("left", x + "px").css("top", y + "px").css("z-index", "99");
