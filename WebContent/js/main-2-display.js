...
function btn() {
	...
	$.ajax({
       	type:"POST",   
       	url:"EchartsTest2_1Action_ajaxQuery", //EchartsTestAction： action类名，ajaxQuery：action类中主方法名，与Struts配置文件匹配
       	contentType: "application/json",
       	data:"", //请求参数
       	processData: false,
       	dataType:'JSON', //设置需要返回的数据类型
       	success:callback2_1, //请求成功处理函数
        error : function() {
               alert("系统异常，请稍后重试！");
        }
    });
	
	function callback2_1(data){
	...
	$.ajax({
       	type:"POST",   
       	url:"EchartsTest2_2Action_ajaxQuery", //EchartsTestAction： action类名，ajaxQuery：action类中主方法名，与Struts配置文件匹配
       	contentType: "application/json",
       	data:"", //请求参数
       	processData: false,
       	dataType:'JSON', //设置需要返回的数据类型
       	success:callback2_2, //请求成功处理函数
           error : function() {
               alert("系统异常，请稍后重试！");
        }
    });
	
	function callback2_2(data){  
	    // 基于准备好的dom，初始化echarts图表
	...
	$.ajax({
       	type:"POST",   
       	url:"EchartsTest2_3Action_ajaxQuery", //EchartsTestAction： action类名，ajaxQuery：action类中主方法名，与Struts配置文件匹配
       	contentType: "application/json",
       	data:"", //请求参数
       	processData: false,
       	dataType:'JSON', //设置需要返回的数据类型
       	success:callback2_3, //请求成功处理函数
           error : function() {
               alert("系统异常，请稍后重试！");
        }
    });
	
	function callback2_3(data){  
	    // 基于准备好的dom，初始化echarts图表
