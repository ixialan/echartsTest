 ...
 */
@Scope("request")
@Controller("tecsoon-ttt") // 注释类别名，-struts.xml文件中action的class的名称,添加注释后由spring托管创建
public class NewAction extends ActionSupport implements SessionAware {
	...
	private Logger logger = LoggerFactory.getLogger(NewAction.class);
