 ...
 */
@Scope("request")
@Controller("tecsoonecharts-index1_3") // 注释类别名，-struts.xml文件中action的class的名称,添加注释后由spring托管创建
public class EchartsTest1_3Action extends ActionSupport implements ServletRequestAware, SessionAware {
	...
	private Logger logger = LoggerFactory.getLogger(EchartsTest1_3Action.class);
...
//			List<Data> dataList = new ArrayList<Data>();
			...
			if (typeName != null && !"".equals(typeName)) {
				...
				if (session.get("chart3") != null) {
					echartsName = String.valueOf(session.get("chart3"));
...
//	    		line3.data(data31, data32, data33, data34, data35, data36, data37);
				...
				CategoryAxis categoryxAxis = new CategoryAxis();
				categoryxAxis.data(dataList.toArray()).type(AxisType.category);
				option.xAxis(categoryxAxis);
				...
				mychart = new Bar();
				((Bar) mychart).data(dataList.toArray());
