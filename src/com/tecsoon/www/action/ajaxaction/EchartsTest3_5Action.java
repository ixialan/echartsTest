 ...
 */
@Scope("request")
@Controller("tecsoonecharts-index3_5") // 注释类别名，-struts.xml文件中action的class的名称,添加注释后由spring托管创建
public class EchartsTest3_5Action extends ActionSupport implements ServletRequestAware {
	...
	private Logger logger = LoggerFactory.getLogger(EchartsTest3_5Action.class);
